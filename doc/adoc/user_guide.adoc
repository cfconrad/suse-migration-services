...
The `preserve` section is used to copy custom configuration files 
(like udev rules) from the old system into the upgrade live system,
ensuring the changes take effect.
This section is organized into three subsections that govern file 
